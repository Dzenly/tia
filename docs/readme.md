...
run.js в параметрах (помимо прочего) получает директорию с тестами.
...
run.js возвращает 0 если тесты прошли ожидаемо и 1, если есть неожиданные дифы.
...
* run.js - утилита для запуска тестов, наберите "node --harmony run.js --help", для просмотра помощи по утилите.
