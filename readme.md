...
* Можно исследовать глобальные объекты (например, sel) в дебажном режиме,
  сделав брейк - поинт в тесте (см. объект global, например global.t, global.sel и т.д.).
...
Спасибо компании R-Vision (https://rvision.pro/) за спонсирование развития движка.
