...
Вот так выглядит локальный конфиг (названия опций должны быть точно такими же как в r-vision/test/lib/dir-config.js):
...
Конфиг опция logToStdErrOut со значением true, приводит к выводу лога в stderr и stdout, см. описание этой опции в r-vision/test/config/dir-config.js.
...
* tia - утилита для запуска тестов, наберите "node --harmony tia --help", для просмотра помощи по утилите.
