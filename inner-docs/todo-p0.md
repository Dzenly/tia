...
Сейчас я просто убиваю процесс в случае рекурсивной ошибки.
Это неправильно.
Должен приходить мейл, что тест завис и убит.

Т.е. по хорошему, надо бы завершить текущий тест.
Может не килять себя, а не реагировать на ошибку?
Браузер останется висеть, но тест сохранится.
