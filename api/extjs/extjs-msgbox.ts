...
export function logTitle(enableLog) {
...
export function logMsg(enableLog) {
...
export function logContent(enableLog) {
...
export function getButtonIdByItemId(itemId, enableLog) {
