 ...
 * Loads and runs the tia-extjs-helpers.js script in context of current browser window.
 ...
 */
gT.e.initTiaExtJsHelpers = function (logAction) {
  return gIn.wrap('Initialization of TIA ExtJs helpers ... ', logAction, function () {
    var scriptStr = fs.readFileSync(path.join(__dirname, 'browser-part/tia-extjs-helpers.js'), 'utf8');
    // gIn.tracer.trace3('initTiaExtJsHelpers: script: ' + scriptStr);
