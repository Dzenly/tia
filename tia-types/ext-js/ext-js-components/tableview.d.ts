...
interface TableViewActions extends ComponentActions {
   ...
   * The cell column is specified by the model field name.
   */
  rClickFirstRowCellByModelField(
    tEQ: Teq,
    fieldName: string,
    idForLog?: ElementIdForLog,
    enableLog?: EnableLog
