 ...
 * just for debug.
 */
export declare type ElementIdForLog = string;
/**
 ...
 */
export declare type EnableLog = boolean;
/**
...
export declare type IdForLog = IdForLogObj | string;
/**
...
export declare type SeleniumKeys = string | number | Array<string | number>;
